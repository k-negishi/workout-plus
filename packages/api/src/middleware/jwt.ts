...
// ハンドラーをモジュールスコープに配置（unicorn/consistent-function-scoping 対応）
...
const jwtHandler: MiddlewareHandler = async (_c, next) => {
  await next();
};
 ...
 */
export const jwtMiddleware = (): MiddlewareHandler => jwtHandler;
